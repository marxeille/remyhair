...
import {requestFilter, requestFilterUnSupport, requestGetUnSupportList} from "../../actions/customer";
...
export default class UnSupport extends Component {
    ...
    componentWillMount(){
        if(_.isEmpty(this.state.customers)){
            ...
            this.props.dispatch(requestGetUnSupportList(this.props.jwt));
        }
    }
    ...
    handlePageChange(pageNumber){
        if(pageNumber){
            ...
            this.props.dispatch(requestFilterUnSupport({
                jwt: this.state.jwt,
                page: pageNumber,
                    ...
                    <td>
                        {
                            ...
                            ?
                            <button type="button"
                                className={ClassNames("btn btn-block btn-sm ", {'btn-success': customer.status}, {'btn-warning': !customer.status})}> <Link to={'/add/support/'+customer.id} className="btn btn-block btn-sm">
                    ...
                    <div className="box-body">
                        <div className="menu">
                            ...
                            <div className={ClassNames({'btn-add-custom': true}, {'hidden' : !hasRole('add-customer', actions)})}>
                                ...
                                <Link to={'customer'} className='btn btn-fat'>
